 ...
 * 格式化 HLSL 代码
 */
function formatHLSLCode(sourceText: string, tabSize: number): string {
    // 统一换行符为\n
...
function provideDocumentFormattingEdits(
    ...
    const newText = formatHLSLCode(document.getText(), options.tabSize);
...
// 格式化工具
const hlslFormattingEditProvider = vscode.languages.registerDocumentFormattingEditProvider('hlsl',
    { provideDocumentFormattingEdits }
);

export { hlslFormattingEditProvider, formatHLSLCode };
